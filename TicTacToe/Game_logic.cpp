...
void processAITurn(Field& field, Sign ai_sign)
{
    ...
    // создаЄм массив индексов пустых клеток пол€:
    ...
    // заполн€ем массив индексами, считаем сколько всего пустых клеток
    ...
    // если это первый ход, ставим знак в центр пол€:
    ...
    for (size_t i = 0; i < last_empty_cell_idx; i++)
    {
        ...
        // ставим в пустую клетку пол€ знак, каких ходит компьютер и если это заканчивает игру, выходим из функции
        ...
        // ставим в пустую клетку пол€ знак, каких ходит игрок и если это заканчивает игру, ставим свой
        ...
        if (outcome.isOver)  // если этим ходом игрок заканчивает игру, мешаем ему, став€ свой знак в эту клетку
        {
    ...
    // если ситуаци€ стабильна и следующий ход игру не закончит, ставим свой знак в любую пустую клетку
